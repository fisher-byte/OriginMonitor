  ...
  try {
    ...
    var result = pages.map(function(page) {
      var crawl = crawlMap[page.url] || {
        ...
        last_human_ts: null,
        last_seen_at: null,
        last_bot_seen_at: null,
        last_human_seen_at: null
      };
...
module.exports._private = {
  parseSitemapEntries: parseSitemapEntries,
  parseSitemapUrls: parseSitemapUrls,
  normalizeUpdatedValue: normalizeUpdatedValue,
  extractUpdatedFromHtml: extractUpdatedFromHtml
};
